...
SELECT SUM(f_name) FROM dependents WHERE em_id = x:em_id;
...
SELECT em_id FROM employees WHERE f_name LIKE 'a%';

--Check if user exists
SELECT f_name, l_name FROM employees WHERE m_id = x:em_id;
